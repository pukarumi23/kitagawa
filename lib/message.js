    ...
    if (typeof content === 'object') {
      ...
      try {
        if (/^https?:\/\//.test(content)) {
          ...
          // ✅ CORREGIDO: usar fileTypeFromBuffer en lugar de FileType.fromBuffer
          const detectedType = await fileTypeFromBuffer(data.data)
          const mime = data.headers['content-type'] || detectedType?.mime
