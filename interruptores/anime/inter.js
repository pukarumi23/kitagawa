...
const captions = {
  ...
  thinkhard: (from, to) => from === to ? `🌺💫 ${global.miku || 'HATSUNE MIKU'} se perdió en un profundo y elegante pensamiento... 🌸` : `🌺💫 ${global.miku || 'HATSUNE MIKU'} está pensando intensamente en`,
  ...
  sniff: (from, to) => from === to ? `🌹💎 Se olfatea como si buscara algo exótico y raro... 🥀` : `🌹💎 Está olfateando a`,
  ...
  draw: (from, to, genero) => from === to ? `✏️🌺 Hace un lindo dibujo con pasión... 🎨💕` : `✏️🌺 Dibuja inspirada en`,
  ...
  bored: (from, to, genero) => from === to ? `😑🌺 Está muy ${genero === 'Hombre' ? 'aburrido' : genero === 'Mujer' ? 'aburrida' : 'aburridx'}... Que alguien la divierta` : `😑🌺 Está ${genero === 'Hombre' ? 'aburrido' : genero === 'Mujer' ? 'aburrida' : 'aburridx'} de`,
  ...
  bonk: (from, to, genero) => from === to ? `💥🌸 Se dio un bonk a sí ${genero === 'Hombre' ? 'mismo' : genero === 'Mujer' ? 'misma' : 'mismx'}... ¡Necesita disciplina!` : `💥🌸 Le dio un golpe a`,
  ...
  bully: (from, to, genero) => from === to ? `😈🌷 Se hace bullying ${genero === 'Hombre' ? 'el mismo' : genero === 'Mujer' ? 'ella misma' : 'el/ella mismx'}... ¡Necesita un abrazo!` : `😈🌷 Le está haciendo bullying a`,
  ...
  cuddle: (from, to, genero) => from === to ? `🤗🌸 Se acurrucó ${genero === 'Hombre' ? 'solo' : genero === 'Mujer' ? 'sola' : 'solx'}... Qué linda💜` : `🤗🌸 Se acurrucó con`,
  ...
  handhold: (from, to, genero) => from === to ? `🤝🌹 Se dio la mano consigo ${genero === 'Hombre' ? 'mismo' : genero === 'Mujer' ? 'misma' : 'mismx'}... Que tierno💕` : `🤝🌹 Le agarró la mano a`,
  ...
  kisscheek: (from, to) => from === to ? `😘🌷 Se besó en la mejilla usando un espejo... Tan linda` : `😘🌷 Le dio un beso en la mejilla a`,
  ...
  love: (from, to, genero) => from === to ? `💕🌷 Se quiere mucho a sí ${genero === 'Hombre' ? 'mismo' : genero === 'Mujer' ? 'misma' : 'mismx'}... Hermoso💜` : `💕🌷 Siente atracción profunda por`,
  pout: (from, to, genero) => from === to ? `😢🌹 Está haciendo pucheros ${genero === 'Hombre' ? 'solo' : genero === 'Mujer' ? 'sola' : 'solx'}... Tan linda 💕` : `😢🌹 Está haciendo pucheros con`,
  ...
  smug: (from, to) => (from === to ? `😏👑 Está presumiendo mucho últimamente... ¡Arrogante! 💜` : `😏👑 Está presumiendo a`),
  think: (from, to) => from === to ? `🤔🌹 Está pensando profundamente... 💭✨` : `🤔🌹 No puede dejar de pensar en`,
  step: (from, to, genero) => from === to ? `🦶🌺 Se pisó a sí ${genero === 'Hombre' ? 'mismo' : genero === 'Mujer' ? 'misma' : 'mismx'} por accidente... ¡Auch!` : `🦶🌺 Está pisando a`,
  ...
  poke: (from, to) => from === to ? `👉🌹 Se picó a sí mismo... ¡No duele! 💪` : `👉🌹 Le da un golpecito a`,
